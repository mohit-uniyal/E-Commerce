  ...
  return (
    <div className='w-full flex flex-col gap-3'>
      ...
      <form className='flex flex-col gap-2 items-center'>
        ...
        <button type="submit" className='w-full text-lg bg-blue-500 rounded-md text-white py-1 hover:bg-blue-600' disabled={requestPending} onClick={handleSubmit}>Create Product</button>
      </form>
    </div>
  )
}
